 ...
 * 10位的数据机器位，可以部署在1024个节点，包括5位data-center-Id和5位workerId<br>
...
public class SnowflakeIdWorker {
    ...
    // ==============================Fields===========================================
    /** 开始时间截 (2020-01-01) */
    private static final long TWEPOCH = 1577811600000L;
    ...
    private static Long getDataCenterId(){
        ...
        if(hostName == null){
            hostName = SystemUtils.getEnvironmentVariable("hostname","default");
        }
